...
Examples:
  owa-vids info  --manifest-url '...videomanifest...&format=dash' --profile globex --pretty
  owa-vids get   --manifest-url '...videomanifest...&format=dash' --profile globex
  owa-vids get   --embed-url 'https://...embed.aspx?uniqueId=...' --profile globex --out talk.mp4
